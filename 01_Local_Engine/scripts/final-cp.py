...
''' + ''.join([f'                        <option value="{district}">{district}</option>\n' for district in sorted_districts]) + '''
            ...
            <div style="display: flex; gap: 4px; margin-top: 6px;">
                <button onclick="loadAllMarkers()" style="flex: 2; background: #2ecc71; color: white; font-size: 13px; padding: 10px; border: none; box-shadow: 0 4px 6px rgba(46, 204, 113, 0.3);">Show All Markers</button>
                <button onclick="showListView()" style="flex: 1; background: #f39c12; color: white; font-size: 13px; padding: 10px; border: none; box-shadow: 0 4px 6px rgba(243, 156, 18, 0.3);">View List</button>
            </div>
