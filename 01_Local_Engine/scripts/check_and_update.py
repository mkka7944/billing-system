    ...
    const ListView = {
        ...
        renderFilters() {
            ...
            State.availableSurveyors.forEach(name => {
                ...
                surveyorOptions += `
                    <div class="multi-option ${isChecked ? 'selected' : ''}" data-value="${name}" onclick="ListView.toggleSurveyor(event, '${name}')" style="padding:4px 8px; margin:0; font-size:11px; display:flex; align-items:center; gap:4px; overflow:hidden;">
            ...
            navFilter.innerHTML = `
                <div style="position:relative;">
                    ...
                    <div id="lv-surveyor-dropdown" style="display:${isVisible ? 'block' : 'none'}; position:absolute; right:0; top:100%; margin-top:8px; background:white; border:1px solid #e2e8f0; border-radius:12px; box-shadow:0 10px 30px rgba(0,0,0,0.15); max-height:800px; overflow-y:auto; min-width:340px; z-index:1001; padding:20px;">
                        <!-- ID Search -->
                        ...
                        <div style="border-top:1px solid #f1f5f9; padding-top:12px;">
                            ...
                            <div style="max-height:250px; overflow-y:auto; border:1px solid #f8fafc; border-radius:8px; padding:4px; background:#f8fafc; display:grid; grid-template-columns:1fr 1fr; gap:2px;">
                                ${surveyorOptions}
                            </div>
                        </div>
                    </div>
        ...
        syncSurveyorOptions() {
            ...
            surveyorScrollArea.style.display = 'grid';
            surveyorScrollArea.style.gridTemplateColumns = '1fr 1fr';
            surveyorScrollArea.style.gap = '2px';
